...
public class TrainExperimentsCoNLLDevTuningGivenConfig {
	...
	public static void main(String[] args) throws Exception{
		...
		ParametersForLbjCode.pathToModelFile=originalModelPath+".ACL2010Experiments.";
		ParametersForLbjCode.debuggingLogPath=originalLogFile+".ACL2010Experiments.";
		System.out.println("-------------------------------------------------------------");
